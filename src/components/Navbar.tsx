...
export const Navbar: React.FC<NavbarProps> = ({ darkMode, setDarkMode, language, setLanguage }) => {
  ...
  const menuItems = [
    ...
    { path: '/report', label: language === 'en' ? 'Report Issue' : 'समस्या रिपोर्ट करें', icon: PlusCircle },
  ...
  if (profile?.role === 'admin') {
    menuItems.push({ path: '/admin', label: language === 'en' ? 'Admin Panel' : 'प्रशासनिक पैनल', icon: ShieldAlert });
  }
