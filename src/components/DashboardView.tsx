...
export const DashboardView: React.FC<DashboardViewProps> = ({ language }) => {
  ...
  const [aiInsights, setAiInsights] = useState<{
    ...
    dailySummary: "Municipal optimization engine loading. Connecting to CiviQ Analytics Agent...",
    recommendations: []
  });
        ...
        const initialReports = [
          {
            ...
            timeline: [
              ...
              { id: '2', status: 'verified', title: 'Community Verified', description: 'Issue confirmed by 8 nearby neighbors.', date: new Date(Date.now() - 1.8 * 24 * 3600 * 1000).toISOString(), updatedBy: 'CiviQ Community' },
                  ...
                  {aiLoading ? (
                    ...
                    <div className="space-y-3">
                      {aiInsights.recommendations.map((rec) => (
                        <div key={rec.id} className="p-3 bg-slate-800/40 rounded-xl border border-slate-800 flex items-start space-x-2.5">
